        ...
        <div class="px-8 py-6">
            <div class="w-full max-w-7xl mx-auto space-y-6">
                ...
                <div class="grid grid-cols-4 gap-4">
                    ...
                    <div class="bg-linear-to-br from-emerald-50 to-emerald-100 rounded-lg p-4 border border-emerald-200">
                    ...
                    <div class="grid grid-cols-5 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                type="text"
                                placeholder="Invoice no, client, notes..."
        ...
        <div v-if="showInvoiceModal" class="fixed inset-0 bg-black/50 flex items-center justify-center z-50 p-4">
            <div class="bg-white rounded-lg shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-y-auto">
                <div class="sticky top-0 bg-linear-to-r from-blue-600 to-blue-700 px-6 py-4 flex items-center justify-between">
                    ...
                    <button @click="showInvoiceModal = false" class="text-white hover:bg-blue-800 p-1 rounded">
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Invoice Type</label>
                            <select v-model="newInvoice.invoiceType" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Vendor / Client</label>
                            <select v-model.number="newInvoice.counterpartyId" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                            <select v-model="newInvoice.status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                                <option v-for="status in statuses" :key="status" :value="status">{{ status }}</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <input v-model="newInvoice.invoiceDate" type="date" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Due Date</label>
                            <input v-model="newInvoice.dueDate" type="date" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <textarea v-model="newInvoice.description" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
                    </div>
                    ...
                    <div class="border border-gray-200 rounded-lg overflow-hidden">
                        <div class="px-4 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
                            ...
                            <button @click="addLineItem" class="px-3 py-1 text-xs font-semibold bg-blue-600 text-white rounded hover:bg-blue-700">Add Item</button>
                        </div>
                        <div class="overflow-x-auto">
                                    ...
                                    <tr v-for="(line, index) in newInvoice.lineItems" :key="line.key">
                                        ...
                                        <td class="px-3 py-2">
                                            <select v-model.number="line.accountId" class="w-52 px-2 py-1 border border-gray-300 rounded" @change="syncLineAccount(index)">
                                                ...
                                                <option v-for="account in filteredAccounts('revenue', line.accountSearch)" :key="account.key" :value="account.id">
                ...
                <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t border-gray-200">
                    ...
                    <button @click="submitInvoice" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-medium transition">Save Invoice</button>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-xl w-full">
                ...
                <div class="p-6 grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                        ...
                        <input id="receivables-payment-attachment-input" type="file" accept=".pdf,image/*" @change="handlePaymentAttachment" class="w-full px-3 py-2 border border-gray-300 rounded-lg" />
...
async function savePayment() {
    ...
    try {
        ...
        const paymentInput = document.getElementById('receivables-payment-attachment-input')
...
async function fetchCounterparties() {
    try {
        ...
        const baseNames = clients.map((client) => {
            return client.name || client.contact_person || client.email || 'Unnamed Client'
        })
